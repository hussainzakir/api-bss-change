...
if [ $env == "BIB" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieBIB=$SESSION_TOKEN" -X GET -L "https://trinetbib.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/email/XILMBDV32J4R/O8N"
fi

if [ $env == "CAB" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieCAB=$SESSION_TOKEN" -X GET -L "https://trinetcab.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/email/XILMBDV32J4R/O8N"
fi


if [ $env == "STAGER" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieSR=$SESSION_TOKEN" -X GET -L "https://trinetsr.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/email/XILMBDV32J4R/O8N"
fi

if [ $env == "LR" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieLR=$SESSION_TOKEN" -X GET -L "https://trinetlr.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/email/XILMBDV32J4R/O8N"
fi

if [ $env == "VAL" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieVAL=$SESSION_TOKEN" -X GET -L "https://trinetval.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/email/XILMBDV32J4R/O8N"
fi


if [ $env == "PROD" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookie=$SESSION_TOKEN" -X GET -L "https://trinet.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/email/XILMBDV32J4R/O8N"
