...
if [ $env == "BIB" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieBIB=$SESSION_TOKEN" -X POST -L "https://trinetbib.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/pre-load-strategies/PAS/Q4/001"
fi

if [ $env == "CAB" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieCAB=$SESSION_TOKEN" -X POST -L "https://trinetcab.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/pre-load-strategies/PAS/Q4/001"
fi


if [ $env == "STAGER" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieSR=$SESSION_TOKEN" -X POST -L "https://trinetsr.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/pre-load-strategies/PAS/Q4/001"
fi

if [ $env == "LR" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieLR=$SESSION_TOKEN" -X POST -L "https://trinetlr.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/pre-load-strategies/PAS/Q4/001"
fi

if [ $env == "VAL" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookieVAL=$SESSION_TOKEN" -X POST -L "https://trinetval.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/pre-load-strategies/PAS/Q4/001"
fi


if [ $env == "PROD" ]
then
curl -H "Content-type: application/json" -H "Cookie:TriNetAuthCookie=$SESSION_TOKEN" -X POST -L "https://trinet.hrpassport.com/api-bss/v1.0/benefits/001/00001437489/pre-load-strategies/PAS/Q4/001"
