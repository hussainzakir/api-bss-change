...
public class StrategyFundingDetailDataDaoImpl implements StrategyFundingDetailDataDao {
	...
	public void updateStrategyFundingDetail(long strategyId, long groupId, String planType, String coverageLevel, BigDecimal contribution) {
		Query query = em.createNamedQuery("UPDATE_STRATEGY_FUNDING_DETAILS");
		...
		DaoUtils.executeUpdate(query, "UPDATE_STRATEGY_FUNDING_DETAILS");
	}
