...
import com.trinet.ambis.persistence.dao.hrp.impl.StrategyFundingFlatMaxDataDaoImpl;

@RunWith(JUnit4.class)
@WebAppConfiguration
public class StrategyFundingFlatMaxDataDaoImplTest {

	@InjectMocks
	StrategyFundingFlatMaxDataDaoImpl strategyFundingFlatMaxDataDao;
	...
	public void updateStrategyFundingFlatMaxTest() {
		...
		strategyFundingFlatMaxDataDao.updateStrategyFundingFlatMax(strategyId, groupId, planType, coverageLevel,
				contribution);
